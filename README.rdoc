...
If you already have a new Rails application created fallow those steps:
...
2. Add following line to Gemfile and then run <code>$ bundle install</code>
    ...
    gem 'social-app-base', :path => "../social-app-base" #:git => "git://github.com/DariuszMichalski/social-app-base.git"
